...
const en = {
  nav: { home: 'Home', about: 'About', companies: 'Companies', services: 'Services', portfolio: 'Portfolio', explore: 'Explore', products: 'Products', careers: 'Careers', contact: 'Contact', quote: 'Get a Quote' },
  hero: {
...
const ar = {
  nav: { home: 'الرئيسية', about: 'من نحن', companies: 'شركاتنا', services: 'خدماتنا', portfolio: 'أعمالنا', explore: 'استكشف', products: 'المنتجات', careers: 'وظائف', contact: 'اتصل بنا', quote: 'احصل على عرض' },
  hero: {
