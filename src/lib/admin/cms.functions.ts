...
const slideSchema = z.object({
  ...
  mobile_media_url: z.string().trim().max(1200).nullable().optional(),
  focal_desktop: z.string().trim().max(40).regex(/^[a-z0-9% .]*$/i).default('center'),
  focal_mobile: z.string().trim().max(40).regex(/^[a-z0-9% .]*$/i).default('center'),
