  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-50 transition-all ${
        scrolled
          ? 'bg-background/95 backdrop-blur shadow-sm border-b border-border py-2'
          : 'bg-background/80 backdrop-blur border-b border-transparent py-3'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-2 rounded-md hover:bg-accent/40 transition"
          >
