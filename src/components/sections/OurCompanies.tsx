...
export function OurCompanies({
  ...
  const [videoUrl, setVideoUrl] = useState(groupVideoUrl || defaultGroupVideo);
  ...
  return (
    <section id="our-groups" className="relative overflow-hidden bg-gradient-to-b from-background via-secondary/20 to-background py-16 sm:py-24">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    <a href="tel:+971557178432" className="block font-semibold hover:text-primary">
                      +971 55 717 8432
                    </a>
                    <a href="tel:+97125522661" className="block font-semibold hover:text-primary">
                      +971 2 552 2661
                    </a>
                  </div>
                </div>
